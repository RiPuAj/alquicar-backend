CREATE DATABASE IF NOT EXISTS alquicardb;
USE alquicardb;
...
-- Crear función UUID_TO_BIN solo si no existe (para MariaDB)
DELIMITER //
...
VALUES 
(UUID_TO_BIN('123e4567-e89b-12d3-a456-426614174000'), 'John Doe', 'john.doe@example.com', '1234', '123 Main St, Cityville', '123456790', 'user', '12345678B'),
...
-- Consultas de verificación (comenta estas si aún no existen esas tablas)
