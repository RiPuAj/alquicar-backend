...
const vehicleWithTokenSchema = z.object({
    token: z.string({ required_error: "Token is required", invalid_type_error: "Token must be a string" }),

    brand: z.enum([
        'Toyota', 'Ford', 'BMW', 'Honda', 'Chevrolet', 'Mercedes-Benz', 'Audi', 'Nissan', 'Volkswagen', 
        'Hyundai', 'Kia', 'Peugeot', 'Mazda', 'Subaru', 'Renault', 'Fiat', 'Porsche', 'Lexus', 'Chrysler', 
        'Dodge', 'Jeep', 'Tesla', 'Land Rover', 'Jaguar', 'Ferrari', 'Lamborghini', 'Aston Martin', 'Maserati', 
        'Bentley', 'Rolls-Royce', 'McLaren'
    ], { 
...
export function validateVehicleWithToken(input){
    return  vehicleWithTokenSchema.safeParse(input)
